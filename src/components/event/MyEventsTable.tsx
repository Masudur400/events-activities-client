...
import { useMyEvents } from '@/hooks/event/useMyEvents'
...
const MyEventsTable: React.FC<MyEventsTableProps> = ({ eventTypes }) => {
    ...
    const { data, isLoading, refetch, isFetching } = useMyEvents({
        searchTerm,
    ...
    const { mutate: deleteEvent, isLoading: deleting } = useDeleteEvent() as any
